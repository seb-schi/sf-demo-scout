...
```json
{
  "phase": 1,
  "deployed": [
    {"type": "CustomObject|CustomField|RecordType|Layout|FlexiPage|CustomTab|CustomApplication|Queue|BusinessProcess|PathAssistant|ValidationRule|ListView|SharingRules|ReportType|ReportFolder|Report|CustomSetting|CustomMetadata", "api_name": "string", "status": "SUCCESS|FAILED", "attempts": 1, "error": null, "lrp_section_target": "string|null — for FlexiPage type only: the field section label the deploy targeted; null otherwise"}
  ],
  "skipped": [
