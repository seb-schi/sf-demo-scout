...
Both halves must be resolved before proceeding to Stage 7b.
...
Once the gate is cleared, proceed to Stage 7b.

---

## Stage 7b: Data Shape Validation
...
**Wait for SE response** if any problems require a design change. Then proceed to Stage 8.

If all objects check out cleanly, proceed to Stage 8 without stopping.
