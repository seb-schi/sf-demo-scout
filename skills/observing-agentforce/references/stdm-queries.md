...
```bash
cp ~/${CLAUDE_PLUGIN_ROOT}/skills/observing-agentforce/apex/AgentforceOptimizeService.cls \
   <project-root>/force-app/main/default/classes/
cp ~/${CLAUDE_PLUGIN_ROOT}/skills/observing-agentforce/apex/AgentforceOptimizeService.cls-meta.xml \
   <project-root>/force-app/main/default/classes/
```
