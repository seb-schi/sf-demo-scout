...
| AWS Bedrock access | Claude Opus thinks. Claude Sonnet builds. Bedrock hosts the party. Complete Steps 0–5 of the [Embark setup guide](https://salesforce.enterprise.slack.com/docs/T01G0063H29/F0ADG6ASE81) first – skip Steps 6–7, `install.sh` handles those. |
